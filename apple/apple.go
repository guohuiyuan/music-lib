...
func (a *Apple) WithCookie(cookie string) {
	na := New(cookie)
	*a = *na
}
...
func SearchPlaylist(keyword string) ([]model.Playlist, error) {
	return defaultApple.SearchPlaylist(keyword)
}
